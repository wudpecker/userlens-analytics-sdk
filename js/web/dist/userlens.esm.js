...
var hasRequiredDOMNode;

function requireDOMNode () {
	if (hasRequiredDOMNode) return DOMNode;
	hasRequiredDOMNode = 1;
	DOMNode.nodeNameInCorrectCase = function nodeNameInCorrectCase(node) {
	...
	DOMNode.shadowRootType = function(node) {
...
var DOMPath$1;
var hasRequiredDOMPath;

function requireDOMPath () {
	if (hasRequiredDOMPath) return DOMPath$1;
	hasRequiredDOMPath = 1;
	...
	requireCss_escape();
	const { ShadowRootTypes, nodeNameInCorrectCase, NodeType } = requireDOMNode();
	...
	DOMPath$1 = Elements.DOMPath;
	return DOMPath$1;
}

var DOMPathExports = requireDOMPath();
var DOMPath = /*@__PURE__*/getDefaultExportFromCjs$3(DOMPathExports);
...
const isAngularZonePresent$1$1 = () => {
...
function getUntaintedPrototype$1$1(key) {
  ...
  if (isUntaintedAccessors && isUntaintedMethods && !isAngularZonePresent$1$1()) {
...
function serializeTextNode(n2, options) {
  ...
  if (isScript) {
    ...
    textContent2 = index$1$1.textContent(n2);
    if (isStyle && textContent2) {
      textContent2 = absolutifyURLs(textContent2, getHref(options.doc));
    }
  }
  if (!isStyle && !isScript && textContent2 && needsMask) {
    textContent2 = maskTextFn ? maskTextFn(textContent2, index$1$1.parentElement(n2)) : textContent2.replace(/[\S]/g, "*");
  }
  return {
...
function getDefaultExportFromCjs$1$1(x2) {
  return x2 && x2.__esModule && Object.prototype.hasOwnProperty.call(x2, "default") ? x2["default"] : x2;
}
function getAugmentedNamespace$1$1(n2) {
...
var picocolors_browser$1$1 = { exports: {} };
var x$1$1 = String;
var create$1$1 = function() {
  return { isColorSupported: false, reset: x$1$1, bold: x$1$1, dim: x$1$1, italic: x$1$1, underline: x$1$1, inverse: x$1$1, hidden: x$1$1, strikethrough: x$1$1, black: x$1$1, red: x$1$1, green: x$1$1, yellow: x$1$1, blue: x$1$1, magenta: x$1$1, cyan: x$1$1, white: x$1$1, gray: x$1$1, bgBlack: x$1$1, bgRed: x$1$1, bgGreen: x$1$1, bgYellow: x$1$1, bgBlue: x$1$1, bgMagenta: x$1$1, bgCyan: x$1$1, bgWhite: x$1$1 };
};
picocolors_browser$1$1.exports = create$1$1();
picocolors_browser$1$1.exports.createColors = create$1$1;
var picocolors_browserExports$1$1 = picocolors_browser$1$1.exports;
const __viteBrowserExternal$2$1 = {};
const __viteBrowserExternal$1$1$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: __viteBrowserExternal$2$1
}, Symbol.toStringTag, { value: "Module" }));
const require$$2$1$1 = /* @__PURE__ */ getAugmentedNamespace$1$1(__viteBrowserExternal$1$1$1);
let pico$1$1 = picocolors_browserExports$1$1;
let terminalHighlight$1$1$1 = require$$2$1$1;
let CssSyntaxError$3$1$1 = class CssSyntaxError extends Error {
  ...
  showSourceCode(color) {
    ...
    let css = this.source;
    if (color == null) color = pico$1$1.isColorSupported;
    if (terminalHighlight$1$1$1) {
      if (color) css = terminalHighlight$1$1$1(css);
    }
    ...
    let mark, aside;
    if (color) {
      let { bold, gray, red } = pico$1$1.createColors(true);
...
var cssSyntaxError$1$1 = CssSyntaxError$3$1$1;
CssSyntaxError$3$1$1.default = CssSyntaxError$3$1$1;
var symbols$1$1 = {};
symbols$1$1.isClean = Symbol("isClean");
symbols$1$1.my = Symbol("my");
const DEFAULT_RAW$1$1 = {
  after: "\n",
  beforeClose: "\n",
  beforeComment: "\n",
  beforeDecl: "\n",
...
function capitalize$1$1(str) {
  return str[0].toUpperCase() + str.slice(1);
}
let Stringifier$2$1$1 = class Stringifier {
  constructor(builder) {
  ...
  raw(node2, own, detect) {
    ...
    if (!parent) return DEFAULT_RAW$1$1[detect];
    ...
    if (detect === "before" || detect === "after") {
      ...
      let method = "raw" + capitalize$1$1(detect);
      if (this[method]) {
    ...
    if (typeof value === "undefined") value = DEFAULT_RAW$1$1[detect];
...
var stringifier$1$1 = Stringifier$2$1$1;
Stringifier$2$1$1.default = Stringifier$2$1$1;
let Stringifier$1$1$1 = stringifier$1$1;
function stringify$4$1$1(node2, builder) {
  let str = new Stringifier$1$1$1(builder);
  str.stringify(node2);
}
var stringify_1$1$1 = stringify$4$1$1;
stringify$4$1$1.default = stringify$4$1$1;
let { isClean: isClean$2$1$1, my: my$2$1$1 } = symbols$1$1;
let CssSyntaxError$2$1$1 = cssSyntaxError$1$1;
let Stringifier2$1$1 = stringifier$1$1;
let stringify$3$1$1 = stringify_1$1$1;
function cloneNode$1$1(obj, parent) {
  ...
  for (let i2 in obj) {
    ...
    if (i2 === "parent" && type === "object") {
      ...
      cloned[i2] = value.map((j) => cloneNode$1$1(j, cloned));
    } else {
      if (type === "object" && value !== null) value = cloneNode$1$1(value);
      cloned[i2] = value;
    }
  }
  return cloned;
}
let Node$4$1$1 = class Node2 {
  constructor(defaults = {}) {
    this.raws = {};
    this[isClean$2$1$1] = false;
    this[my$2$1$1] = true;
  ...
  error(message, opts = {}) {
    ...
    return new CssSyntaxError$2$1$1(message);
  }
  getProxyProcessor() {
    return {
      get(node2, prop) {
  ...
  markDirty() {
    if (this[isClean$2$1$1]) {
      this[isClean$2$1$1] = false;
      let next = this;
      while (next = next.parent) {
        next[isClean$2$1$1] = false;
      }
    }
  }
  next() {
  ...
  toString(stringifier2 = stringify$3$1$1) {
...
var node$1$1 = Node$4$1$1;
Node$4$1$1.default = Node$4$1$1;
let Node$3$1$1 = node$1$1;
let Declaration$4$1$1 = class Declaration extends Node$3$1$1 {
  constructor(defaults) {
...
var declaration$1$1 = Declaration$4$1$1;
Declaration$4$1$1.default = Declaration$4$1$1;
let urlAlphabet$1$1 = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";
let nanoid$1$1$1 = (size = 21) => {
  let id = "";
  let i2 = size;
  while (i2--) {
    id += urlAlphabet$1$1[Math.random() * 64 | 0];
  }
  return id;
};
var nonSecure$1$1 = { nanoid: nanoid$1$1$1};
let { SourceMapConsumer: SourceMapConsumer$2$1$1, SourceMapGenerator: SourceMapGenerator$2$1$1 } = require$$2$1$1;
let { existsSync: existsSync$1$1, readFileSync: readFileSync$1$1 } = require$$2$1$1;
let { dirname: dirname$1$1$1, join: join$1$1 } = require$$2$1$1;
function fromBase64$1$1(str) {
  if (Buffer) {
...
let PreviousMap$2$1$1 = class PreviousMap {
  constructor(css, opts) {
    ...
    if (this.mapFile) this.root = dirname$1$1$1(this.mapFile);
    if (text) this.text = text;
  }
  consumer() {
    if (!this.consumerCache) {
      this.consumerCache = new SourceMapConsumer$2$1$1(this.text);
    }
  ...
  decodeInline(text) {
    ...
    if (baseCharsetUri.test(text) || baseUri.test(text)) {
      return fromBase64$1$1(text.substr(RegExp.lastMatch.length));
    }
  ...
  loadFile(path) {
    this.root = dirname$1$1$1(path);
    if (existsSync$1$1(path)) {
      this.mapFile = path;
      return readFileSync$1$1(path, "utf-8").toString().trim();
    }
  }
  loadMap(file, prev) {
    ...
    if (prev) {
      ...
      } else if (prev instanceof SourceMapConsumer$2$1$1) {
        return SourceMapGenerator$2$1$1.fromSourceMap(prev).toString();
      } else if (prev instanceof SourceMapGenerator$2$1$1) {
      ...
      if (file) map = join$1$1(dirname$1$1$1(file), map);
...
var previousMap$1$1 = PreviousMap$2$1$1;
PreviousMap$2$1$1.default = PreviousMap$2$1$1;
let { SourceMapConsumer: SourceMapConsumer$1$1$1, SourceMapGenerator: SourceMapGenerator$1$1$1 } = require$$2$1$1;
let { fileURLToPath: fileURLToPath$1$1, pathToFileURL: pathToFileURL$1$1$1 } = require$$2$1$1;
let { isAbsolute: isAbsolute$1$1, resolve: resolve$1$1$1 } = require$$2$1$1;
let { nanoid: nanoid$2$1 } = nonSecure$1$1;
let terminalHighlight$2$1 = require$$2$1$1;
let CssSyntaxError$1$1$1 = cssSyntaxError$1$1;
let PreviousMap$1$1$1 = previousMap$1$1;
let fromOffsetCache$1$1 = Symbol("fromOffsetCache");
let sourceMapAvailable$1$1$1 = Boolean(SourceMapConsumer$1$1$1 && SourceMapGenerator$1$1$1);
let pathAvailable$1$1$1 = Boolean(resolve$1$1$1 && isAbsolute$1$1);
let Input$4$1$1 = class Input {
  constructor(css, opts = {}) {
    ...
    if (opts.from) {
      if (!pathAvailable$1$1$1 || /^\w+:\/\//.test(opts.from) || isAbsolute$1$1(opts.from)) {
        this.file = opts.from;
      } else {
        this.file = resolve$1$1$1(opts.from);
      }
    }
    if (pathAvailable$1$1$1 && sourceMapAvailable$1$1$1) {
      let map = new PreviousMap$1$1$1(this.css, opts);
      if (map.text) {
        this.map = map;
    ...
    if (!this.file) {
      this.id = "<input css " + nanoid$2$1(6) + ">";
    }
  ...
  error(message, line, column, opts = {}) {
    ...
    if (origin) {
      result2 = new CssSyntaxError$1$1$1(
        message,
    ...
    if (this.file) {
      if (pathToFileURL$1$1$1) {
        result2.input.url = pathToFileURL$1$1$1(this.file).toString();
      }
  ...
  fromOffset(offset) {
    ...
    if (!this[fromOffsetCache$1$1]) {
      ...
      this[fromOffsetCache$1$1] = lineToIndex;
    } else {
      lineToIndex = this[fromOffsetCache$1$1];
    }
  ...
  mapResolve(file) {
    ...
    return resolve$1$1$1(this.map.consumer().sourceRoot || this.map.root || ".", file);
  }
  origin(line, column, endLine, endColumn) {
    ...
    let fromUrl;
    if (isAbsolute$1$1(from.source)) {
      fromUrl = pathToFileURL$1$1$1(from.source);
    } else {
      fromUrl = new URL(
        from.source,
        this.map.consumer().sourceRoot || pathToFileURL$1$1$1(this.map.mapFile)
      );
    }
    let result2 = {
      column: from.column,
    ...
    if (fromUrl.protocol === "file:") {
      if (fileURLToPath$1$1) {
        result2.file = fileURLToPath$1$1(fromUrl);
      } else {
...
var input$1$1 = Input$4$1$1;
Input$4$1$1.default = Input$4$1$1;
if (terminalHighlight$2$1 && terminalHighlight$2$1.registerInput) {
  terminalHighlight$2$1.registerInput(Input$4$1$1);
}
let { SourceMapConsumer: SourceMapConsumer$3$1, SourceMapGenerator: SourceMapGenerator$3$1 } = require$$2$1$1;
let { dirname: dirname$2$1, relative: relative$1$1, resolve: resolve$2$1, sep: sep$1$1 } = require$$2$1$1;
let { pathToFileURL: pathToFileURL$2$1 } = require$$2$1$1;
let Input$3$1$1 = input$1$1;
let sourceMapAvailable$2$1 = Boolean(SourceMapConsumer$3$1 && SourceMapGenerator$3$1);
let pathAvailable$2$1 = Boolean(dirname$2$1 && resolve$2$1 && relative$1$1 && sep$1$1);
let MapGenerator$2$1$1 = class MapGenerator {
  ...
  applyPrevMaps() {
    for (let prev of this.previous()) {
      ...
      let root2 = prev.root || dirname$2$1(prev.file);
      let map;
      if (this.mapOpts.sourcesContent === false) {
        map = new SourceMapConsumer$3$1(prev.text);
  ...
  generate() {
    ...
    if (pathAvailable$2$1 && sourceMapAvailable$2$1 && this.isMap()) {
  ...
  generateMap() {
    if (this.root) {
      ...
      this.map = SourceMapGenerator$3$1.fromSourceMap(prev, {
        ignoreInvalidMapping: true
      });
    } else {
      this.map = new SourceMapGenerator$3$1({
  ...
  path(file) {
    ...
    let from = this.opts.to ? dirname$2$1(this.opts.to) : ".";
    if (typeof this.mapOpts.annotation === "string") {
      from = dirname$2$1(resolve$2$1(from, this.mapOpts.annotation));
    }
    let path = relative$1$1(from, file);
  ...
  previous() {
    if (!this.previousMaps) {
      ...
      if (this.root) {
        ...
        let input2 = new Input$3$1$1(this.originalCSS, this.opts);
  ...
  toFileUrl(path) {
    ...
    if (cached) return cached;
    if (pathToFileURL$2$1) {
      let fileURL = pathToFileURL$2$1(path).toString();
...
var mapGenerator$1$1 = MapGenerator$2$1$1;
let Node$2$1$1 = node$1$1;
let Comment$4$1$1 = class Comment extends Node$2$1$1 {
  constructor(defaults) {
    super(defaults);
    this.type = "comment";
  }
};
var comment$1$1 = Comment$4$1$1;
Comment$4$1$1.default = Comment$4$1$1;
let { isClean: isClean$1$1$1, my: my$1$1$1 } = symbols$1$1;
let Declaration$3$1$1 = declaration$1$1;
let Comment$3$1$1 = comment$1$1;
let Node$1$1$1 = node$1$1;
let parse$4$1$1, Rule$4$1$1, AtRule$4$1$1, Root$6$1$1;
function cleanSource$1$1(nodes) {
  return nodes.map((i2) => {
    if (i2.nodes) i2.nodes = cleanSource$1$1(i2.nodes);
    delete i2.source;
    return i2;
  });
}
function markDirtyUp$1$1(node2) {
  node2[isClean$1$1$1] = false;
...
let Container$7$1$1 = class Container extends Node$1$1$1 {
  append(...children) {
  ...
  normalize(nodes, sample) {
    if (typeof nodes === "string") {
      nodes = cleanSource$1$1(parse$4$1$1(nodes).nodes);
      ...
      nodes = [new Declaration$3$1$1(nodes)];
    } else if (nodes.selector) {
      nodes = [new Rule$4$1$1(nodes)];
    } else if (nodes.name) {
      nodes = [new AtRule$4$1$1(nodes)];
    } else if (nodes.text) {
      nodes = [new Comment$3$1$1(nodes)];
    } else {
      throw new Error("Unknown node type in node creation");
    }
    let processed = nodes.map((i2) => {
      if (!i2[my$1$1$1]) Container.rebuild(i2);
      i2 = i2.proxyOf;
      if (i2.parent) i2.parent.removeChild(i2);
      if (i2[isClean$1$1$1]) markDirtyUp$1$1(i2);
      if (typeof i2.raws.before === "undefined") {
...
Container$7$1$1.registerParse = (dependant) => {
  parse$4$1$1 = dependant;
};
Container$7$1$1.registerRule = (dependant) => {
  Rule$4$1$1 = dependant;
};
Container$7$1$1.registerAtRule = (dependant) => {
  AtRule$4$1$1 = dependant;
};
Container$7$1$1.registerRoot = (dependant) => {
  Root$6$1$1 = dependant;
};
var container$1$1 = Container$7$1$1;
Container$7$1$1.default = Container$7$1$1;
Container$7$1$1.rebuild = (node2) => {
  if (node2.type === "atrule") {
    Object.setPrototypeOf(node2, AtRule$4$1$1.prototype);
  } else if (node2.type === "rule") {
    Object.setPrototypeOf(node2, Rule$4$1$1.prototype);
  } else if (node2.type === "decl") {
    Object.setPrototypeOf(node2, Declaration$3$1$1.prototype);
  } else if (node2.type === "comment") {
    Object.setPrototypeOf(node2, Comment$3$1$1.prototype);
  } else if (node2.type === "root") {
    Object.setPrototypeOf(node2, Root$6$1$1.prototype);
  }
  node2[my$1$1$1] = true;
  if (node2.nodes) {
    node2.nodes.forEach((child) => {
      Container$7$1$1.rebuild(child);
    });
  }
};
let Container$6$1$1 = container$1$1;
let LazyResult$4$1$1, Processor$3$1$1;
let Document$3$1$1 = class Document2 extends Container$6$1$1 {
  constructor(defaults) {
  ...
  toResult(opts = {}) {
    let lazy = new LazyResult$4$1$1(new Processor$3$1$1(), this, opts);
    return lazy.stringify();
  }
};
Document$3$1$1.registerLazyResult = (dependant) => {
  LazyResult$4$1$1 = dependant;
};
Document$3$1$1.registerProcessor = (dependant) => {
  Processor$3$1$1 = dependant;
};
var document$1$1$1 = Document$3$1$1;
Document$3$1$1.default = Document$3$1$1;
let printed$1$1 = {};
var warnOnce$2$1$1 = function warnOnce(message) {
  if (printed$1$1[message]) return;
  printed$1$1[message] = true;
  if (typeof console !== "undefined" && console.warn) {
    console.warn(message);
  }
};
let Warning$2$1$1 = class Warning {
...
var warning$1$1 = Warning$2$1$1;
Warning$2$1$1.default = Warning$2$1$1;
let Warning$1$1$1 = warning$1$1;
let Result$3$1$1 = class Result {
  ...
  warn(text, opts = {}) {
    ...
    let warning2 = new Warning$1$1$1(text, opts);
...
var result$1$1 = Result$3$1$1;
Result$3$1$1.default = Result$3$1$1;
const SINGLE_QUOTE$1$1 = "'".charCodeAt(0);
const DOUBLE_QUOTE$1$1 = '"'.charCodeAt(0);
const BACKSLASH$1$1 = "\\".charCodeAt(0);
const SLASH$1$1 = "/".charCodeAt(0);
const NEWLINE$1$1 = "\n".charCodeAt(0);
const SPACE$1$1 = " ".charCodeAt(0);
const FEED$1$1 = "\f".charCodeAt(0);
const TAB$1$1 = "	".charCodeAt(0);
const CR$1$1 = "\r".charCodeAt(0);
const OPEN_SQUARE$1$1 = "[".charCodeAt(0);
const CLOSE_SQUARE$1$1 = "]".charCodeAt(0);
const OPEN_PARENTHESES$1$1 = "(".charCodeAt(0);
const CLOSE_PARENTHESES$1$1 = ")".charCodeAt(0);
const OPEN_CURLY$1$1 = "{".charCodeAt(0);
const CLOSE_CURLY$1$1 = "}".charCodeAt(0);
const SEMICOLON$1$1 = ";".charCodeAt(0);
const ASTERISK$1$1 = "*".charCodeAt(0);
const COLON$1$1 = ":".charCodeAt(0);
const AT$1$1 = "@".charCodeAt(0);
const RE_AT_END$1$1 = /[\t\n\f\r "#'()/;[\\\]{}]/g;
const RE_WORD_END$1$1 = /[\t\n\f\r !"#'():;@[\\\]{}]|\/(?=\*)/g;
const RE_BAD_BRACKET$1$1 = /.[\r\n"'(/\\]/;
const RE_HEX_ESCAPE$1$1 = /[\da-f]/i;
var tokenize$1$1 = function tokenizer(input2, options = {}) {
  ...
  function nextToken(opts) {
    ...
    switch (code) {
      ...
      case FEED$1$1: {
        ...
        } while (code === SPACE$1$1 || code === NEWLINE$1$1 || code === TAB$1$1 || code === CR$1$1 || code === FEED$1$1);
        currentToken = ["space", css.slice(pos, next)];
        pos = next - 1;
        break;
      }
      case OPEN_SQUARE$1$1:
      case CLOSE_SQUARE$1$1:
      case OPEN_CURLY$1$1:
      case CLOSE_CURLY$1$1:
      case COLON$1$1:
      case SEMICOLON$1$1:
      case CLOSE_PARENTHESES$1$1: {
        let controlChar = String.fromCharCode(code);
        currentToken = [controlChar, controlChar, pos];
        break;
      }
      case OPEN_PARENTHESES$1$1: {
        prev = buffer.length ? buffer.pop()[1] : "";
        n2 = css.charCodeAt(pos + 1);
        if (prev === "url" && n2 !== SINGLE_QUOTE$1$1 && n2 !== DOUBLE_QUOTE$1$1 && n2 !== SPACE$1$1 && n2 !== NEWLINE$1$1 && n2 !== TAB$1$1 && n2 !== FEED$1$1 && n2 !== CR$1$1) {
          next = pos;
          do {
            escaped = false;
            ...
            escapePos = next;
            while (css.charCodeAt(escapePos - 1) === BACKSLASH$1$1) {
              escapePos -= 1;
              escaped = !escaped;
            }
          } while (escaped);
          ...
          if (next === -1 || RE_BAD_BRACKET$1$1.test(content)) {
            currentToken = ["(", "(", pos];
          } else {
      ...
      case SINGLE_QUOTE$1$1:
      case DOUBLE_QUOTE$1$1: {
        quote = code === SINGLE_QUOTE$1$1 ? "'" : '"';
        next = pos;
        do {
          escaped = false;
      ...
      case AT$1$1: {
        RE_AT_END$1$1.lastIndex = pos + 1;
        RE_AT_END$1$1.test(css);
        if (RE_AT_END$1$1.lastIndex === 0) {
          next = css.length - 1;
        } else {
          next = RE_AT_END$1$1.lastIndex - 2;
        }
      ...
      case BACKSLASH$1$1: {
        next = pos;
        escape = true;
        while (css.charCodeAt(next + 1) === BACKSLASH$1$1) {
          next += 1;
          escape = !escape;
        }
        code = css.charCodeAt(next + 1);
        if (escape && code !== SLASH$1$1 && code !== SPACE$1$1 && code !== NEWLINE$1$1 && code !== TAB$1$1 && code !== CR$1$1 && code !== FEED$1$1) {
          next += 1;
          if (RE_HEX_ESCAPE$1$1.test(css.charAt(next))) {
            while (RE_HEX_ESCAPE$1$1.test(css.charAt(next + 1))) {
              next += 1;
            }
            if (css.charCodeAt(next + 1) === SPACE$1$1) {
              next += 1;
            }
          }
        }
      ...
      default: {
        if (code === SLASH$1$1 && css.charCodeAt(pos + 1) === ASTERISK$1$1) {
          ...
          RE_WORD_END$1$1.lastIndex = pos + 1;
          RE_WORD_END$1$1.test(css);
          if (RE_WORD_END$1$1.lastIndex === 0) {
            next = css.length - 1;
          } else {
            next = RE_WORD_END$1$1.lastIndex - 2;
          }
          currentToken = ["word", css.slice(pos, next + 1), pos, next];
...
let Container$5$1$1 = container$1$1;
let AtRule$3$1$1 = class AtRule extends Container$5$1$1 {
  constructor(defaults) {
    super(defaults);
    this.type = "atrule";
  }
...
var atRule$1$1 = AtRule$3$1$1;
AtRule$3$1$1.default = AtRule$3$1$1;
Container$5$1$1.registerAtRule(AtRule$3$1$1);
let Container$4$1$1 = container$1$1;
let LazyResult$3$1$1, Processor$2$1$1;
let Root$5$1$1 = class Root extends Container$4$1$1 {
  constructor(defaults) {
    super(defaults);
    this.type = "root";
  ...
  toResult(opts = {}) {
    let lazy = new LazyResult$3$1$1(new Processor$2$1$1(), this, opts);
    return lazy.stringify();
  }
};
Root$5$1$1.registerLazyResult = (dependant) => {
  LazyResult$3$1$1 = dependant;
};
Root$5$1$1.registerProcessor = (dependant) => {
  Processor$2$1$1 = dependant;
};
var root$1$1 = Root$5$1$1;
Root$5$1$1.default = Root$5$1$1;
Container$4$1$1.registerRoot(Root$5$1$1);
let list$2$1$1 = {
  comma(string) {
    return list$2$1$1.split(string, [","], true);
  },
  space(string) {
    let spaces = [" ", "\n", "	"];
    return list$2$1$1.split(string, spaces);
  },
...
var list_1$1$1 = list$2$1$1;
list$2$1$1.default = list$2$1$1;
let Container$3$1$1 = container$1$1;
let list$1$1$1 = list_1$1$1;
let Rule$3$1$1 = class Rule extends Container$3$1$1 {
  constructor(defaults) {
    super(defaults);
    this.type = "rule";
    if (!this.nodes) this.nodes = [];
  ...
  get selectors() {
    return list$1$1$1.comma(this.selector);
  }
...
var rule$1$1 = Rule$3$1$1;
Rule$3$1$1.default = Rule$3$1$1;
Container$3$1$1.registerRule(Rule$3$1$1);
let Declaration$2$1$1 = declaration$1$1;
let tokenizer2$1$1 = tokenize$1$1;
let Comment$2$1$1 = comment$1$1;
let AtRule$2$1$1 = atRule$1$1;
let Root$4$1$1 = root$1$1;
let Rule$2$1$1 = rule$1$1;
const SAFE_COMMENT_NEIGHBOR$1$1 = {
  empty: true,
  space: true
};
function findLastWithPosition$1$1(tokens) {
...
let Parser$1$1$1 = class Parser {
  constructor(input2) {
    this.input = input2;
    this.root = new Root$4$1$1();
  ...
  createTokenizer() {
    this.tokenizer = tokenizer2$1$1(this.input);
  }
  decl(tokens, customProperty) {
    let node2 = new Declaration$2$1$1();
    ...
    node2.source.end = this.getPosition(
      last[3] || last[2] || findLastWithPosition$1$1(tokens)
    );
    node2.source.end.offset++;
  ...
  raw(node2, prop, tokens, customProperty) {
    ...
    for (let i2 = 0; i2 < length; i2 += 1) {
      ...
      if (type === "space" && i2 === length - 1 && !customProperty) {
        ...
        if (!SAFE_COMMENT_NEIGHBOR$1$1[prev] && !SAFE_COMMENT_NEIGHBOR$1$1[next]) {
          if (value.slice(-1) === ",") {
            clean = false;
          } else {
            value += token[1];
...
var parser$1$1 = Parser$1$1$1;
let Container$2$1$1 = container$1$1;
let Parser2$1$1 = parser$1$1;
let Input$2$1$1 = input$1$1;
function parse$3$1$1(css, opts) {
  let input2 = new Input$2$1$1(css, opts);
  let parser2 = new Parser2$1$1(input2);
  try {
    parser2.parse();
  } catch (e2) {
...
var parse_1$1$1 = parse$3$1$1;
parse$3$1$1.default = parse$3$1$1;
Container$2$1$1.registerParse(parse$3$1$1);
let { isClean: isClean$3$1, my: my$3$1 } = symbols$1$1;
let MapGenerator$1$1$1 = mapGenerator$1$1;
let stringify$2$1$1 = stringify_1$1$1;
let Container$1$1$1 = container$1$1;
let Document$2$1$1 = document$1$1$1;
let warnOnce$1$1$1 = warnOnce$2$1$1;
let Result$2$1$1 = result$1$1;
let parse$2$1$1 = parse_1$1$1;
let Root$3$1$1 = root$1$1;
const TYPE_TO_CLASS_NAME$1$1 = {
  atrule: "AtRule",
  comment: "Comment",
  decl: "Declaration",
  document: "Document",
...
const NOT_VISITORS$1$1 = {
  Once: true,
  postcssPlugin: true,
  prepare: true
};
const CHILDREN$1$1 = 0;
function isPromise$1$1(obj) {
  return typeof obj === "object" && typeof obj.then === "function";
}
function getEvents$1$1(node2) {
  let key = false;
  let type = TYPE_TO_CLASS_NAME$1$1[node2.type];
  if (node2.type === "decl") {
  ...
  if (key && node2.append) {
    ...
    return [type, CHILDREN$1$1, type + "Exit"];
  } else {
    return [type, type + "Exit"];
  }
}
function toStack$1$1(node2) {
  let events;
  if (node2.type === "document") {
    events = ["Document", CHILDREN$1$1, "DocumentExit"];
  } else if (node2.type === "root") {
    events = ["Root", CHILDREN$1$1, "RootExit"];
  } else {
    events = getEvents$1$1(node2);
  }
  return {
    eventIndex: 0,
    events,
...
function cleanMarks$1$1(node2) {
  node2[isClean$3$1] = false;
  if (node2.nodes) node2.nodes.forEach((i2) => cleanMarks$1$1(i2));
  return node2;
}
let postcss$2$1$1 = {};
let LazyResult$2$1$1 = class LazyResult {
  constructor(processor2, css, opts) {
    this.stringified = false;
    this.processed = false;
    let root2;
    if (typeof css === "object" && css !== null && (css.type === "root" || css.type === "document")) {
      root2 = cleanMarks$1$1(css);
    } else if (css instanceof LazyResult || css instanceof Result$2$1$1) {
      root2 = cleanMarks$1$1(css.root);
      if (css.map) {
      ...
      if (root2 && !root2[my$3$1]) {
        Container$1$1$1.rebuild(root2);
      }
    }
    this.result = new Result$2$1$1(processor2, root2, opts);
    this.helpers = { ...postcss$2$1$1, postcss: postcss$2$1$1, result: this.result };
  ...
  async runAsync() {
    ...
    if (this.hasListener) {
      ...
      while (!root2[isClean$3$1]) {
        root2[isClean$3$1] = true;
        let stack = [toStack$1$1(root2)];
  ...
  stringify() {
    ...
    let str = stringify$2$1$1;
    if (opts.syntax) str = opts.syntax.stringify;
    if (opts.stringifier) str = opts.stringifier;
    if (str.stringify) str = str.stringify;
    let map = new MapGenerator$1$1$1(str, this.result.root, this.result.opts);
  ...
  visitTick(stack) {
    ...
    if (visit2.iterator !== 0) {
      ...
      while (child = node2.nodes[node2.indexes[iterator]]) {
        ...
        if (!child[isClean$3$1]) {
          child[isClean$3$1] = true;
          stack.push(toStack$1$1(child));
          return;
        }
      }
      visit2.iterator = 0;
    ...
    while (visit2.eventIndex < events.length) {
      ...
      visit2.eventIndex += 1;
      if (event === CHILDREN$1$1) {
        if (node2.nodes && node2.nodes.length) {
          node2[isClean$3$1] = true;
  ...
  walkSync(node2) {
    node2[isClean$3$1] = true;
    let events = getEvents$1$1(node2);
    for (let event of events) {
      if (event === CHILDREN$1$1) {
        if (node2.nodes) {
          node2.each((child) => {
            if (!child[isClean$3$1]) this.walkSync(child);
          });
        }
      } else {
...
LazyResult$2$1$1.registerPostcss = (dependant) => {
  postcss$2$1$1 = dependant;
};
var lazyResult$1$1 = LazyResult$2$1$1;
LazyResult$2$1$1.default = LazyResult$2$1$1;
Root$3$1$1.registerLazyResult(LazyResult$2$1$1);
Document$2$1$1.registerLazyResult(LazyResult$2$1$1);
let MapGenerator2$1$1 = mapGenerator$1$1;
let stringify$1$1$1 = stringify_1$1$1;
let warnOnce2$1$1 = warnOnce$2$1$1;
let parse$1$1$1 = parse_1$1$1;
const Result$1$1$1 = result$1$1;
let NoWorkResult$1$1$1 = class NoWorkResult {
  constructor(processor2, css, opts) {
    css = css.toString();
    this.stringified = false;
    ...
    this._map = void 0;
    let root2;
    let str = stringify$1$1$1;
    this.result = new Result$1$1$1(this._processor, root2, this._opts);
    this.result.css = css;
    let self = this;
    ...
    let map = new MapGenerator2$1$1(str, root2, this._opts, css);
    if (map.isMap()) {
...
var noWorkResult$1$1 = NoWorkResult$1$1$1;
NoWorkResult$1$1$1.default = NoWorkResult$1$1$1;
let NoWorkResult2$1$1 = noWorkResult$1$1;
let LazyResult$1$1$1 = lazyResult$1$1;
let Document$1$1$1 = document$1$1$1;
let Root$2$1$1 = root$1$1;
let Processor$1$1$1 = class Processor {
  constructor(plugins = []) {
    this.version = "8.4.38";
  ...
  process(css, opts = {}) {
    if (!this.plugins.length && !opts.parser && !opts.stringifier && !opts.syntax) {
      return new NoWorkResult2$1$1(this, css, opts);
    } else {
      return new LazyResult$1$1$1(this, css, opts);
    }
  }
  use(plugin22) {
...
var processor$1$1 = Processor$1$1$1;
Processor$1$1$1.default = Processor$1$1$1;
Root$2$1$1.registerProcessor(Processor$1$1$1);
Document$1$1$1.registerProcessor(Processor$1$1$1);
let Declaration$1$1$1 = declaration$1$1;
let PreviousMap2$1$1 = previousMap$1$1;
let Comment$1$1$1 = comment$1$1;
let AtRule$1$1$1 = atRule$1$1;
let Input$1$1$1 = input$1$1;
let Root$1$1$1 = root$1$1;
let Rule$1$1$1 = rule$1$1;
function fromJSON$1$1$1(json, inputs) {
  if (Array.isArray(json)) return json.map((n2) => fromJSON$1$1$1(n2));
  let { inputs: ownInputs, ...defaults } = json;
  if (ownInputs) {
    inputs = [];
    for (let input2 of ownInputs) {
      let inputHydrated = { ...input2, __proto__: Input$1$1$1.prototype };
      if (inputHydrated.map) {
        inputHydrated.map = {
          ...inputHydrated.map,
          __proto__: PreviousMap2$1$1.prototype
        };
      }
  ...
  if (defaults.nodes) {
    defaults.nodes = json.nodes.map((n2) => fromJSON$1$1$1(n2, inputs));
  }
  if (defaults.source) {
  ...
  if (defaults.type === "root") {
    return new Root$1$1$1(defaults);
  } else if (defaults.type === "decl") {
    return new Declaration$1$1$1(defaults);
  } else if (defaults.type === "rule") {
    return new Rule$1$1$1(defaults);
  } else if (defaults.type === "comment") {
    return new Comment$1$1$1(defaults);
  } else if (defaults.type === "atrule") {
    return new AtRule$1$1$1(defaults);
  } else {
    throw new Error("Unknown node type: " + json.type);
  }
}
var fromJSON_1$1$1 = fromJSON$1$1$1;
fromJSON$1$1$1.default = fromJSON$1$1$1;
let CssSyntaxError2$1$1 = cssSyntaxError$1$1;
let Declaration2$1$1 = declaration$1$1;
let LazyResult2$1$1 = lazyResult$1$1;
let Container2$1$1 = container$1$1;
let Processor2$1$1 = processor$1$1;
let stringify$5$1 = stringify_1$1$1;
let fromJSON$2$1 = fromJSON_1$1$1;
let Document22$1 = document$1$1$1;
let Warning2$1$1 = warning$1$1;
let Comment2$1$1 = comment$1$1;
let AtRule2$1$1 = atRule$1$1;
let Result2$1$1 = result$1$1;
let Input2$1$1 = input$1$1;
let parse$5$1 = parse_1$1$1;
let list$3$1 = list_1$1$1;
let Rule2$1$1 = rule$1$1;
let Root2$1$1 = root$1$1;
let Node2$1$1 = node$1$1;
function postcss$3$1(...plugins) {
  if (plugins.length === 1 && Array.isArray(plugins[0])) {
    plugins = plugins[0];
  }
  return new Processor2$1$1(plugins);
}
postcss$3$1.plugin = function plugin(name, initializer) {
  ...
  function creator(...args) {
    ...
    transformer.postcssVersion = new Processor2$1$1().version;
    return transformer;
  }
  let cache;
  ...
  creator.process = function(css, processOpts, pluginOpts) {
    return postcss$3$1([creator(pluginOpts)]).process(css, processOpts);
  };
  return creator;
};
postcss$3$1.stringify = stringify$5$1;
postcss$3$1.parse = parse$5$1;
postcss$3$1.fromJSON = fromJSON$2$1;
postcss$3$1.list = list$3$1;
postcss$3$1.comment = (defaults) => new Comment2$1$1(defaults);
postcss$3$1.atRule = (defaults) => new AtRule2$1$1(defaults);
postcss$3$1.decl = (defaults) => new Declaration2$1$1(defaults);
postcss$3$1.rule = (defaults) => new Rule2$1$1(defaults);
postcss$3$1.root = (defaults) => new Root2$1$1(defaults);
postcss$3$1.document = (defaults) => new Document22$1(defaults);
postcss$3$1.CssSyntaxError = CssSyntaxError2$1$1;
postcss$3$1.Declaration = Declaration2$1$1;
postcss$3$1.Container = Container2$1$1;
postcss$3$1.Processor = Processor2$1$1;
postcss$3$1.Document = Document22$1;
postcss$3$1.Comment = Comment2$1$1;
postcss$3$1.Warning = Warning2$1$1;
postcss$3$1.AtRule = AtRule2$1$1;
postcss$3$1.Result = Result2$1$1;
postcss$3$1.Input = Input2$1$1;
postcss$3$1.Rule = Rule2$1$1;
postcss$3$1.Root = Root2$1$1;
postcss$3$1.Node = Node2$1$1;
LazyResult2$1$1.registerPostcss(postcss$3$1);
var postcss_1$1$1 = postcss$3$1;
postcss$3$1.default = postcss$3$1;
const postcss$1$1$1 = /* @__PURE__ */ getDefaultExportFromCjs$1$1(postcss_1$1$1);
postcss$1$1$1.stringify;
postcss$1$1$1.fromJSON;
postcss$1$1$1.plugin;
postcss$1$1$1.parse;
postcss$1$1$1.list;
postcss$1$1$1.document;
postcss$1$1$1.comment;
postcss$1$1$1.atRule;
postcss$1$1$1.rule;
postcss$1$1$1.decl;
postcss$1$1$1.root;
postcss$1$1$1.CssSyntaxError;
postcss$1$1$1.Declaration;
postcss$1$1$1.Container;
postcss$1$1$1.Processor;
postcss$1$1$1.Document;
postcss$1$1$1.Comment;
postcss$1$1$1.Warning;
postcss$1$1$1.AtRule;
postcss$1$1$1.Result;
postcss$1$1$1.Input;
postcss$1$1$1.Rule;
postcss$1$1$1.Root;
postcss$1$1$1.Node;
...
var __publicField2$1 = (obj, key, value) => __defNormalProp2$1(obj, typeof key !== "symbol" ? key + "" : key, value);
...
let Stringifier22$1 = stringifier$2;
...
let Parser$1$2 = class Parser2 {
  ...
  createTokenizer() {
    this.tokenizer = tokenizer22$1(this.input);
  }
  decl(tokens, customProperty) {
...
let MapGenerator22$1 = mapGenerator$2;
let stringify$1$2 = stringify_1$2;
let warnOnce22$1 = warnOnce$2$2;
...
let NoWorkResult$1$2 = class NoWorkResult2 {
  constructor(processor2, css, opts) {
    ...
    let map = new MapGenerator22$1(str, root2, this._opts, css);
    if (map.isMap()) {
      let [generatedCSS, generatedMap] = map.generate();
      if (generatedCSS) {
        this.result.css = generatedCSS;
...
let NoWorkResult22$1 = noWorkResult$2;
...
let Processor$1$2 = class Processor2 {
  ...
  process(css, opts = {}) {
    if (!this.plugins.length && !opts.parser && !opts.stringifier && !opts.syntax) {
      return new NoWorkResult22$1(this, css, opts);
    } else {
...
let PreviousMap22$1 = previousMap$2;
  ...
  if (ownInputs) {
    ...
    for (let input2 of ownInputs) {
      ...
      if (inputHydrated.map) {
        inputHydrated.map = {
          ...inputHydrated.map,
          __proto__: PreviousMap22$1.prototype
        };
      }
      inputs.push(inputHydrated);
    }
...
let CssSyntaxError22$1 = cssSyntaxError$2;
let Declaration22$1 = declaration$2;
let LazyResult22$1 = lazyResult$2;
let Container22$1 = container$2;
let Processor22$1 = processor$2;
let stringify$7 = stringify_1$2;
let fromJSON$3 = fromJSON_1$2;
let Document222$1 = document$1$2;
let Warning22$1 = warning$2;
let Comment22$1 = comment$2;
let AtRule22$1 = atRule$2;
let Result22$1 = result$2;
let Input22$1 = input$2;
...
function postcss$4(...plugins) {
  ...
  return new Processor22$1(plugins);
}
postcss$4.plugin = function plugin2(name, initializer) {
  ...
  function creator(...args) {
    ...
    let transformer = initializer(...args);
    transformer.postcssPlugin = name;
    transformer.postcssVersion = new Processor22$1().version;
    return transformer;
  }
  let cache;
  Object.defineProperty(creator, "postcss", {
...
postcss$4.stringify = stringify$7;
postcss$4.parse = parse$6;
postcss$4.fromJSON = fromJSON$3;
postcss$4.list = list$4;
postcss$4.comment = (defaults) => new Comment22$1(defaults);
postcss$4.atRule = (defaults) => new AtRule22$1(defaults);
postcss$4.decl = (defaults) => new Declaration22$1(defaults);
postcss$4.rule = (defaults) => new Rule22$1(defaults);
postcss$4.root = (defaults) => new Root22$1(defaults);
postcss$4.document = (defaults) => new Document222$1(defaults);
postcss$4.CssSyntaxError = CssSyntaxError22$1;
postcss$4.Declaration = Declaration22$1;
postcss$4.Container = Container22$1;
postcss$4.Processor = Processor22$1;
postcss$4.Document = Document222$1;
postcss$4.Comment = Comment22$1;
postcss$4.Warning = Warning22$1;
postcss$4.AtRule = AtRule22$1;
postcss$4.Result = Result22$1;
postcss$4.Input = Input22$1;
postcss$4.Rule = Rule22$1;
postcss$4.Root = Root22$1;
postcss$4.Node = Node22$1;
LazyResult22$1.registerPostcss(postcss$4);
...
let BaseRRNode$1 = class BaseRRNode {
  ...
  constructor(..._args) {
    __publicField2$1(this, "parentElement", null);
    __publicField2$1(this, "parentNode", null);
    __publicField2$1(this, "ownerDocument");
    __publicField2$1(this, "firstChild", null);
    __publicField2$1(this, "lastChild", null);
    __publicField2$1(this, "previousSibling", null);
    __publicField2$1(this, "nextSibling", null);
    __publicField2$1(this, "ELEMENT_NODE", 1);
    __publicField2$1(this, "TEXT_NODE", 3);
    __publicField2$1(this, "nodeType");
    __publicField2$1(this, "nodeName");
    __publicField2$1(this, "RRNodeType");
  }
  get childNodes() {
    const childNodes2 = [];
...
class MutationBuffer {
  constructor() {
    ...
    __publicField$2(this, "removesSubTreeCache", /* @__PURE__ */ new Set());
...
export { EventCollector, SessionRecorder, EventTracker as default };
