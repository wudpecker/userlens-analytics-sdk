...
Userlens Analytics SDK is a TypeScript library that automatically captures user interactions (clicks, page views) in web applications. Core philosophy: "Track everything. Decide what matters later."

- Browser-only analytics SDK (React integration included)
- Auto-captures all clicks with DOM snapshots and page navigation
